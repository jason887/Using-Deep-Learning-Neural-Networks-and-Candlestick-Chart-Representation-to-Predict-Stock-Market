...
def build_model(SHAPE, nb_classes, bn_axis, seed=None):
    ...
    # # Step 1
    # classifier.add(Conv2D(48, 3, 3, init='glorot_uniform', border_mode='same',
    #                              activation='relu'))
    # # Step 2 - Pooling
    # classifier.add(MaxPooling2D(pool_size=(2, 2)))
    ...
    # # Step 1
    # classifier.add(Conv2D(64, 3, 3, init='glorot_uniform', border_mode='same',
    #                              activation='relu'))
    # # Step 2 - Pooling
    # classifier.add(MaxPooling2D(pool_size=(2, 2)))

    # # Step 1
    # classifier.add(Conv2D(96, 3, 3, init='glorot_uniform', border_mode='same',
    #                              activation='relu'))
    # # Step 2 - Pooling
    # classifier.add(MaxPooling2D(pool_size=(2, 2)))
    # classifier.add(Dropout(0.25))
