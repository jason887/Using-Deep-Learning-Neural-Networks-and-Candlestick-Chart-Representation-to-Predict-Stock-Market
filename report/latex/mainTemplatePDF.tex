...
\usepackage{authblk}
\usepackage{amsmath}
\usepackage[width=.40\textwidth]{caption}
\hypersetup{
    colorlinks=true,
    linkcolor=blue,
    filecolor=magenta,      
...
\affil[2]{Department of Computer Science and Engineering, National Taiwan University of Science and Technology, Taipei, Taiwan Roc}
