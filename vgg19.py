...
def save_bottlebeck_features():
    ...
    np.save('bottleneck_features_train_vgg19_{}'.format(period), bottleneck_features_train)
    ...
    np.save('bottleneck_features_validation_vgg19_{}'.format(period),
            bottleneck_features_validation)


def train_top_model():
    train_data = np.load('bottleneck_features_train_vgg19_{}.npy'.format(period))
